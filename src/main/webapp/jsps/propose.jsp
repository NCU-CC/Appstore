        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    ...
                    <h2>中央大學電子計算機中心智慧型裝置應用程式提案說明</h2>
                        
<h4>一、提案目的</h4>

        <p>本提案說明，旨在邀集中央大學有能力開發智慧型裝置應用程式的在學學生，可以藉此開發出符合中央大學教職員工使用的應用程式，同時增加學生的工讀機會，也增加訓練的機會。
</p>
        <br>
<h4>二、提案方式</h4>

        <p>提案人以書面或電子文件方式，依照<a href='<c:url value='/doc/proposal_exp.docx'/>'>提案範例</a>再遞送至志希館電子計算機中心行動應用程式開發小組組長處（或寄mobile@cc.ncu.edu.tw），接著進入資料審核程序，若核可將會與您約時間議價簽約，成立後即行開發。
</p>
        <br>
<h4>三、提案注意事項</h4>
     <ul>   
...
<li>若提案人有違反簽訂合約內容之行為，本中心有權利取消該提案之一切權益，並進行法律上一切必要行為。</li>
</ul>
