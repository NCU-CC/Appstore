			...
			<nav id="mainmenu" class="mainmenu">
				<ul>
					<li class="logo-wrapper">
						<a href="/appstore">
							<img src="<c:url value='/img/mPurpose-logo.png'/>" alt="NCU appstore logo">
						</a>
					</li>
					<li>
					...
					<struts:if test="#session.personInfo != null && #session.personInfo.type == 'ADMIN'">
						<li class="has-submenu"><a href="#">管理App</a>
					...
					<li>
						<a href="<struts:url action="oauth"/>">NCU OAuth</a>
					</li>
					...
					<struts:if test="#session.personInfo != null">
						<li><a href="<struts:url action="logout"/>">登出</a></li>
					</struts:if>
				</ul>
			</nav>
		</div>
