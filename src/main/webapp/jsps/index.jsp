...
<jsp:include page="header.jsp"></jsp:include>
	        	...
	        	<div class="row">
	        		...
	        		<div class="col-md-4 col-sm-6">
	        			<div class="service-wrapper">
		        			...
		        			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#studentdeclaration">
                              聲明
                            </button>
		        		</div>
	        		</div>
	        		...
	        		<div class="col-md-4 col-sm-6">
                        <div class="service-wrapper">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#officialdeclaration">
                              聲明
                            </button>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="service-wrapper">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#unofficialdeclaration">
                              聲明
                            </button>
                        </div>
                    </div>
	  ...
	  <!-- Modal -->
<div class="modal fade" id="touristdeclaration" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <jsp:include page="touristdeclaration.jsp"></jsp:include>
</div>
<div class="modal fade" id="studentdeclaration" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <jsp:include page="studentdeclaration.jsp"></jsp:include>
</div>
<div class="modal fade" id="teacherdeclaration" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <jsp:include page="teacherdeclaration.jsp"></jsp:include>
</div>
<div class="modal fade" id="officialdeclaration" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <jsp:include page="officialdeclaration.jsp"></jsp:include>
</div>
<div class="modal fade" id="unofficialdeclaration" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
